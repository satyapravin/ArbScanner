...
class OneInchGetter {
    constructor() {
        ...
        this.getExpectedReturnWithGas = async function(fromToken, toToken, amount) {
            ...
            return new Promise(function(resolve, reject) {
                    axios.get('https://api.1inch.exchange/v4.0/250/quote', {
                        params: {
                            fromTokenAddress: fromAddress,
                            toTokenAddress: toAddress,
                            amount: amount,
                    ...
                    }).then((response) => resolve([fromToken, toToken, amount, response.data.toTokenAmount, response.data.estimatedGas])).catch (e => {
                        //console.log(fromToken, toToken, amount);
                        //console.log(e)
                        //return reject(e);
